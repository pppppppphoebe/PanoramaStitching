...
class Uniform:
    ...
    def addInt(self, name, number):
        self.ints.append([name, number])
    ...
    def update(self, shader):
        ...
        for intNum in self.ints:
            location = glGetUniformLocation(shader, intNum[0])
            glUniform1i(location, intNum[1])
